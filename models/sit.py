...
def SiT_B_shallow_2(**kwargs):
    # NEW: SiT-B/2 with depth=6 (half the standard depth).
    # Same hidden_size=768 and num_heads=12 as SiT-B/2 — fair comparison,
    # just fewer layers to reduce memorization capacity on small datasets.
    return SiT(depth=6, hidden_size=768, decoder_hidden_size=768, patch_size=2, num_heads=12, **kwargs)
...
SiT_models = {
    ...
    'SiT-B-shallow/2': SiT_B_shallow_2,            # NEW
